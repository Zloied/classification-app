package com.vais.config.keycloak;
...
public class EmbeddedKeycloakConfig {
	...
	/**
	 * Mock a JNDI environment to use a spring/datasource
	 * @param dataSource that should be used (PostgreSQL, MySQL H2 Database, e.t.c)
